...
#define CE_PIN 3  //define the CE pins
#define CSN_PIN 4 //define the CSN pins
...
void loop() {
   ...
   *part that afects the angles and ofcourse multiply by 0.98 */
   ...
   String angle="001,"+String(totalAngleInterpolation1)+","+String(totalAngleInterpolation2);
